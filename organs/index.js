...
import { renderHeader, renderFooter, loadData, loadClinical, link, esc, paths, PRERENDERED, SITE, breadcrumbHtml } from '../site/site.js?v=1.5.0';
import { relatedCountForAnatomy } from '../site/entity.js?v=1.5.0';
