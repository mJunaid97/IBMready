...
export async function renderMedicationClasses() {
  ...
  if (!PRERENDERED) {
    ...
    main.innerHTML = `${breadcrumbHtml(crumbs)}
      ...
      <p class="actions"><a class="btn btn-primary" href="${link.checker()}">Medication interaction checker</a><a class="btn" href="${typeLink('drug-classes')}">Drug class pages A–Z</a><a class="btn" href="${typeLink('medications')}">Medicines A–Z</a></p></div>
