...
import { renderHeader, renderFooter, TYPES, typeLink, entityLink, link, loadClinical, esc, fmt, SITE, PRERENDERED } from './site.js?v=1.2.0';
import { applyMeta, webPageNode } from './seo.js?v=1.2.0';
...
if (!PRERENDERED) {
  ...
  document.getElementById('everyday').innerHTML = card('first-aid') + card('health') + `<a class="card" href="${link.interactions()}"><div class="icon">💊</div><h3>Interaction checker</h3><p>Add medicines, brands, drug classes or combination products and see what the official sources say about each pair: mechanism, management and monitoring, never a bare "safe".</p></a><a class="card" href="${link.compare()}"><div class="icon">⚖️</div><h3>Comparisons</h3><p>CRP vs ESR, creatinine vs eGFR, ECG vs echocardiogram, CT vs MRI, TSH vs free T4, HbA1c vs glucose, atorvastatin vs rosuvastatin: what each is for and how they differ.</p></a><a class="card" href="${link.search()}"><div class="icon">🔍</div><h3>Search everything</h3><p>One search across structures, organs, systems, terms and every clinical topic, with results that link straight into the 3D atlas.</p></a>`;
