 ...
 */
import { renderHeader, renderFooter, loadClinical, loadComparisons, link, entityLink, typeLink, esc, pageId, paths, PRERENDERED, SITE, TYPES, breadcrumbHtml, canonical, iconSvg } from './site.js?v=1.8.1';
import { applyMeta, seoTitle, metaDescription, webPageNode } from './seo.js?v=1.8.1';
import { referencesHtml, editorialHtml } from './entity.js?v=1.8.1';
