 ...
 */
import { renderHeader, renderFooter, loadClinical, loadComparisons, link, entityLink, typeLink, esc, pageId, paths, PRERENDERED, SITE, TYPES, breadcrumbHtml, canonical, iconSvg } from './site.js?v=1.4.0';
import { applyMeta, seoTitle, metaDescription, webPageNode } from './seo.js?v=1.4.0';
import { referencesHtml, editorialHtml } from './entity.js?v=1.4.0';
