 ...
 */
import { normalize, search as rankSearch } from '../explorer/search.js?v=1.1.2';
import { CONFIG } from './config.js?v=1.1.2';
import { VERSION, BUILD } from './version.js?v=1.1.2';
import { SITE } from './site-meta.js?v=1.1.2';
import { previewName } from './preview-name.js?v=1.1.2';
