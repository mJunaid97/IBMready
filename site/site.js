 ...
 */
import { normalize, search as rankSearch } from '../explorer/search.js?v=1.8.0';
import { CONFIG } from './config.js?v=1.8.0';
import { VERSION, BUILD } from './version.js?v=1.8.0';
import { SITE } from './site-meta.js?v=1.8.0';
import { previewName } from './preview-name.js?v=1.8.0';
...
export const NAV_GROUPS = [
  ...
  ['Clinical', [['symptoms', 'Symptoms', () => typeLink('symptoms')], ['conditions', 'Conditions', () => typeLink('conditions')], ['tests', 'Medical tests', () => typeLink('tests')], ['test-categories', 'Test categories', () => link.testCategories()], ['biomarkers', 'Biomarkers', () => typeLink('biomarkers')], ['imaging', 'Imaging', () => typeLink('imaging')], ['procedures', 'Procedures', () => typeLink('procedures')]]],
  ['Medicines', [['medications', 'Medications', () => typeLink('medications')], ['drug-classes', 'Drug classes', () => typeLink('drug-classes')], ['medication-classes', 'Medication taxonomy', () => link.medicationClasses()], ['targets', 'Drug targets', () => typeLink('targets')], ['checker', 'Drug Interaction Checker', () => link.checker()], ['tools', 'Clinical tools', () => link.tools()], ['compare', 'Comparisons', () => link.compare()]]],
