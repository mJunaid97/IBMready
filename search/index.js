...
import { renderHeader, renderFooter, searchEntries, runSearch, anyLink, TYPE_LABEL, TYPES, esc, param } from '../site/site.js?v=1.1.2';
import { applyStaticMeta } from '../site/seo.js?v=1.1.2';
