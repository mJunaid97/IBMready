...
import { renderHeader, renderFooter, loadData, loadClinical, link, esc, paths, PRERENDERED, SITE, breadcrumbHtml, canonical, fmt, iconSvg, structuresLabel } from '../site/site.js?v=1.8.0';
import { relatedCountForAnatomy } from '../site/entity.js?v=1.8.0';
import { applyMeta, metaDescription, webPageNode } from '../site/seo.js?v=1.8.0';
