...
import { renderHeader, renderFooter, loadData, loadClinical, link, esc, pageId, paths, PRERENDERED, SITE, breadcrumbHtml, facadeHtml, canonical, entityLink, TYPE_ORDER } from '../site/site.js?v=1.3.0';
import { relatedForAnatomy, relatedCountForAnatomy, referencesHtml, editorialHtml } from '../site/entity.js?v=1.3.0';
import { applyMeta, seoTitle, metaDescription, webPageNode } from '../site/seo.js?v=1.3.0';
