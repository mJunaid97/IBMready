...
import { renderHeader, renderFooter, loadData, link, esc, fmt, paths, PRERENDERED, SITE, breadcrumbHtml, canonical } from '../site/site.js?v=1.8.1';
import { applyMeta, metaDescription, webPageNode } from '../site/seo.js?v=1.8.1';
...
if (!PRERENDERED) {
  ...
  document.getElementById('main').innerHTML = `
    ...
    <p class="lead">The atlas is organised into nineteen systems, the way anatomy is taught: the skeleton and its joints, the muscles, the heart and vessels, the nervous system and senses, the organ systems of the trunk, the male and the female reproductive organs, and the anatomy after vaginoplasty and after phalloplasty. Each page gives an overview, functions, clinical notes, the organs it contains and every modelled structure, with the system ready to open in 3D.</p></div>
