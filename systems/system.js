...
import { renderHeader, renderFooter, loadData, loadClinical, link, esc, fmt, pageId, paths, PRERENDERED, SITE, breadcrumbHtml, facadeHtml, canonical, structuresLabel } from '../site/site.js?v=1.7.0';
import { relatedForAnatomy, relatedCountForAnatomy, editorialHtml } from '../site/entity.js?v=1.7.0';
