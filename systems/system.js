...
import { renderHeader, renderFooter, loadData, loadClinical, link, esc, fmt, pageId, paths, PRERENDERED, SITE, breadcrumbHtml, facadeHtml, canonical } from '../site/site.js?v=1.5.0';
import { relatedForAnatomy, relatedCountForAnatomy, editorialHtml } from '../site/entity.js?v=1.5.0';
